...
namespace hdt
{
    ...
    auto SkyrimSystemCreator::createOrUpdateSystem(RE::NiNode* skeleton, RE::NiAVObject* model,
                                                   ...
                                                   std::unordered_map<RE::BSFixedString, RE::BSFixedString>&&
                                                   renameMap,
    ...
    {
        auto name = getRenamedBone(m_reader->getAttribute("name"));
        ...
        auto cls = m_reader->getAttribute("template", "");
