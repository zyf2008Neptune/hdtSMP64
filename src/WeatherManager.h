...
namespace hdt
{
    ...
    private:
        ...
        static constexpr std::array NOT_EXTERIOR_WORLDS = {
            0x69857u, 0x1EE62u, 0x20DCBu, 0x1FAE2u, 0x34240u, 0x50015u, 0x2C965u, 0x29AB7u, 0x4F838u, 0x3A9D6u,
            0x243DEu, 0xC97EBu, 0xC350Du, 0x1CDD3u, 0x1CDD9u, 0x21EDBu, 0x1E49Du, 0x2B101u, 0x2A9D8u, 0x20BFEu};
        ...
        auto randomGeneratorLowMoreProbable(int lowerMin, int lowerMax, int higherMin, int higherMax, int probability)
            -> int;
    };
} // namespace hdt
