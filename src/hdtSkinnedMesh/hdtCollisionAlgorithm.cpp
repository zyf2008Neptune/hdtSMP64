...
namespace hdt
{
    ...
    [[maybe_unused]] static auto signedDistanceFromPointToPlane(const btVector3& point, const btVector3& n, float c,
                                                                btVector3& closestPointOnFace) -> float
    {
    ...
    [[maybe_unused]] static auto segmentSqrDistance(const btVector3& from, const btVector3& to, const btVector3& p,
                                                    btVector3& nearest) -> float
    {
    ...
    [[maybe_unused]] static auto linePlaneIntersection(btVector3& contact, const btVector3& p0, const btVector3& p1,
                                                       const btVector3& normal, const btVector3& coord,
                                                       float radius) -> bool
    {
        // get d value
