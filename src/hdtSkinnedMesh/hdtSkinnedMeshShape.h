...
namespace hdt
{
    ...
    public:
        ...
        auto baryCoord([[maybe_unused]] const Collider* c,
                       [[maybe_unused]] const btVector3& p) -> btVector3 final
        {
            return {1, 1, 1};
        }

        auto baryWeight([[maybe_unused]] const btVector3& w,
                        [[maybe_unused]] int boneIdx) -> float final
        {
            return 1;
        }
