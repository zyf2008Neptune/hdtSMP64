...
namespace hdt
{
    namespace
    {
        auto convertFloat(const std::string& str) -> float
        {
            ...
            const float ret = strtof(s.c_str(), nullptr);
    ...
    namespace
    {
        auto convertInt(const std::string& str) -> int
        {
            ...
            const int ret = strtol(str.c_str(), &end, radix);
    ...
    {
        const auto ret = Base::GetInspected();
    ...
    {
        Inspect();
        const auto ret = convertFloat(GetValue());
        skipCurrentElement();
        return ret;
    }
    ...
    {
        Inspect();
        const auto ret = convertInt(GetValue());
        skipCurrentElement();
        return ret;
    }
    ...
    {
        Inspect();
        const auto ret = convertBool(GetValue());
        skipCurrentElement();
        return ret;
    }
    ...
    {
        const float x = getAttributeAsFloat("x");
        const float y = getAttributeAsFloat("y");
        const float z = getAttributeAsFloat("z");
        skipCurrentElement();
        return {x, y, z};
    }
    ...
    auto XMLReader::readQuaternion() -> btQuaternion
    {
        ...
        const float y = getAttributeAsFloat("y");
        const float z = getAttributeAsFloat("z");
        const float w = getAttributeAsFloat("w");
        skipCurrentElement();
